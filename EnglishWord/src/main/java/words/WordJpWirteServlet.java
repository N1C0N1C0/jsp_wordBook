 ...
 */
@WebServlet("/wordJpWirte.do")
public class WordJpWirteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WordJpWirteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String id = (String)session.getAttribute("USER");
			...
			dto.setId(id);	// 작성자
			String result = dao.insertJpWord(dto);	// 게시글 등록
			response.sendRedirect("index.jsp?BODY=wordJpWriteResult.jsp?R="+result);
