...
@WebServlet("/wordJpModify.do")
public class WordJpModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WordJpModifyServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(btn.equals("삭제")) {
			result = dao.deleteJpWord(Integer.parseInt(seqno));
			...
			result = dao.updateJpWord(dto);
		}
		response.sendRedirect("index.jsp?BODY=wordJpModifyResult.jsp?R="+result);
	}
